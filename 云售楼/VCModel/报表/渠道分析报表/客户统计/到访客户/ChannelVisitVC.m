...
@interface ChannelVisitVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:ProjectClientValue_URL parameters:dic success:^(id resposeObject) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *CellIdentifier = @"ChannelRecommendCell";
    
    ChannelRecommendCell *cell  = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (!cell) {
        cell = [[ChannelRecommendCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
