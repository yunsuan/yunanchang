...
@implementation WorkRecommendFailVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WorkRecommendFailDetailVC *nextVC = [[WorkRecommendFailDetailVC alloc] initWithClientId:_dataArr[indexPath.row][@"client_id"]];
