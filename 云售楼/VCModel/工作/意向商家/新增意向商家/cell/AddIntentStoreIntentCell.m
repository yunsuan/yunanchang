...
@interface AddIntentStoreIntentCell ()<UITextFieldDelegate>

@end

@implementation AddIntentStoreIntentCell
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    if (self.addIntentStoreIntentCellStrBlock) {

        self.addIntentStoreIntentCellStrBlock(textField.text, textField.tag);
    }
}
...
- (void)ActionTimeBtn:(UIButton *)btn{
    ...
    if (self.addIntentStoreIntentCellTimeBlock) {

        self.addIntentStoreIntentCellTimeBlock();
    }
}

- (void)ActionPeriodTimeBtn:(UIButton *)btn{
    
    if (self.addIntentStoreIntentCellPeriod1Block) {

        self.addIntentStoreIntentCellPeriod1Block();
    }
}

- (void)ActionPeriodTime2Btn:(UIButton *)btn{
    
    if (self.addIntentStoreIntentCellPeriod2Block) {

        self.addIntentStoreIntentCellPeriod2Block();
    }
}
