...
@interface AddIntentSelectStoreVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@implementation AddIntentSelectStoreVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.addIntentSelectStoreVCBlock) {
        
        self.addIntentSelectStoreVCBlock(_dataArr[indexPath.row]);
    }
