...
//        _chargeId = [NSString stringWithFormat:@"%@",dataDic[@"shop_detail_list"][@"charge_company_id"]];
        ...
        NSMutableDictionary *tempDic = [[NSMutableDictionary alloc] initWithDictionary:self->_dataDic[@"business_info"]];
        [tempDic setValue:[NSString stringWithFormat:@"%@",self->_dataDic[@"business_id"]] forKey:@"business_id"];
...
//    }
    ...
    [dic setValue:[NSString stringWithFormat:@"%@",self->_dataDic[@"row_id"]] forKey:@"from_id"];
