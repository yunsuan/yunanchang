...
@interface WorkPhoneConfrimUseDetailVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation WorkPhoneConfrimUseDetailVC
...
//    [BaseRequest GET:ButterTelValueDetail_URL parameters:@{@"client_id":_clientId} success:^(id resposeObject) {
//
//        NSLog(@"%@",resposeObject);
...
- (void)SetData:(NSDictionary *)data{
    ...
    _dataDic = data;
    _titleArr = @[@[[NSString stringWithFormat:@"推荐编号：%@",data[@"client_id"]],[NSString stringWithFormat:@"推荐时间：%@",data[@"create_time"]],[NSString stringWithFormat:@"推荐类别：%@",data[@"recommend_type"]],[NSString stringWithFormat:@"推荐人：%@",data[@"broker_name"]],[NSString stringWithFormat:@"联系方式：%@",data[@"broker_tel"]],[NSString stringWithFormat:@"项目名称：%@",data[@"project_name"]],[NSString stringWithFormat:@"项目地址：%@",data[@"absolute_address"]],[NSString stringWithFormat:@"客户姓名：%@",data[@"name"]],[NSString stringWithFormat:@"客户性别：%@",[data[@"sex"] integerValue] == 1 ? @"男":@"女"],[NSString stringWithFormat:@"联系方式：%@",data[@"tel"]],[NSString stringWithFormat:@"备注：%@",data[@"client_comment"]]],@[[NSString stringWithFormat:@"确认人：%@",data[@"tel_check_info"][@"confirmed_agent_name"]],[NSString stringWithFormat:@"联系方式：%@",data[@"tel_check_info"][@"confirmed_agent_tel"]],[NSString stringWithFormat:@"确认时间：%@",data[@"tel_check_info"][@"confirmed_time"]],@"判重结果：可带看"]];
