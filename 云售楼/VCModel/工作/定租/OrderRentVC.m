...
@interface OrderRentVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:TradeSubGetTradeSubList_URL parameters:dic success:^(id  _Nonnull resposeObject) {
...
- (void)ActionRightBtn:(UIButton *)btn{
    ...
    AddOrderRentVC *nextVC = [[AddOrderRentVC alloc] initWithProjectId:_project_id info_id:_info_id];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    OrderRentDetailVC *nextVC = [[OrderRentDetailVC alloc] initWithBusinessId:[NSString stringWithFormat:@"%@",_dataArr[indexPath.row][@"sub_id"]]];
