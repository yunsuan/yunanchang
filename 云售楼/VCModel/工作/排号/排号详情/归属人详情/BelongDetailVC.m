...
@interface BelongDetailVC ()<UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
{
...
//    cell.dataDic = _dataArr[indexPath.item];
    cell.nameL.text = [NSString stringWithFormat:@"归属人：%@",_dataArr[indexPath.item][@"name"]];
