...
@interface AddNumeralModifyCustomVC ()<UITextFieldDelegate>
{
...
@implementation AddNumeralModifyCustomVC
...
- (void)ActionNextBtn:(UIButton *)btn{
    ...
    [BaseRequest POST:WorkClientAutoClientUpdate_URL parameters:tempDic success:^(id  _Nonnull resposeObject) {
        ...
        if ([resposeObject[@"code"] integerValue] == 200) {
            ...
            self.addNumeralModifyCustomVCEditBlock(tempDic);
