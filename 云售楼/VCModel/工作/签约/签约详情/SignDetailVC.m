        ...
        if ([resposeObject[@"code"] integerValue] == 200) {
            ...
            self->_dataArr = [NSMutableArray arrayWithArray:
                              @[
                                ...
                                @[[NSString stringWithFormat:@"登记时间：%@",self->_dataDic[@"contract_time"]],[NSString stringWithFormat:@"登记人：%@",self->_dataDic[@"contract_agent_name"]],[NSString stringWithFormat:@"归属时间：%@",self->_dataDic[@"own_time"]]]]];
