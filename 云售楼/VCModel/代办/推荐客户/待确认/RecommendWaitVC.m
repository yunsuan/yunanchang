...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.recommendCustomCellBlock = ^(NSInteger idx) {
      
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"确认" message:@"" preferredStyle:UIAlertControllerStyleActionSheet];
        
        UIAlertAction *effective = [UIAlertAction actionWithTitle:@"有效" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            
        }];
        
        UIAlertAction *invalid = [UIAlertAction actionWithTitle:@"无效" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
