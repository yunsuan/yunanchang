...
@interface RecommendCustomVC ()<UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,UIScrollViewDelegate,UITextFieldDelegate>
{
...
@implementation RecommendCustomVC
...
- (void)initUI{
    ...
    [_segmentColl registerClass:[TypeTagCollCell class] forCellWithReuseIdentifier:@"RoomAgencyCollCell"];
