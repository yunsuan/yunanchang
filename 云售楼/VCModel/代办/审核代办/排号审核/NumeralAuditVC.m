...
#import "NumeralAuditVC.h"

#import "NumeralAuditDetailVC.h"

#import "AuditTaskCell.h"

@interface NumeralAuditVC ()<UITableViewDelegate,UITableViewDataSource>
{
    NSArray *_dataArr;
    NSString *_page;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NumeralAuditDetailVC *next_vc = [[NumeralAuditDetailVC alloc]init];
