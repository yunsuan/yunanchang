...
#import "ContractAuditVC.h"

#import "ContractAuditDetailVC.h"

#import "AuditTaskCell.h"

@interface ContractAuditVC ()<UITableViewDelegate,UITableViewDataSource>
{
    NSArray *_dataArr;
    NSString *_page;
}
...
@implementation ContractAuditVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ContractAuditDetailVC *next_vc = [[ContractAuditDetailVC alloc]init];
