...
@implementation ShopFreePeriodChangeAuditCell
...
- (void)ActionAuditBtn:(UIButton *)btn{
    ...
    if (self.shopFreePeriodChangeAuditCellAuditBlock) {

        self.shopFreePeriodChangeAuditCellAuditBlock(self.tag);
    }
}
...
- (void)setDataDic:(NSMutableDictionary *)dataDic{
    ...
    _originPeriodL.text = [NSString stringWithFormat:@"原免租期长：%@",dataDic[@"sign_agent_name"]];
    _changePeriodL.text = [NSString stringWithFormat:@"变更免租期长：%@",dataDic[@"sign_agent_name"]];
}
