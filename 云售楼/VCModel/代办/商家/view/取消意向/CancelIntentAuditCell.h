...
typedef void(^CancelIntentAuditCellAuditBlock)(NSInteger index);

@interface CancelIntentAuditCell : UITableViewCell

@property (nonatomic, copy) CancelIntentAuditCellAuditBlock cancelIntentAuditCellAuditBlock;
