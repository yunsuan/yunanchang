...
@implementation FreeOverTimeProcessCell
...
- (void)ActionAuditBtn:(UIButton *)btn{
    ...
    if (self.freeOverTimeProcessCellAuditBlock) {

        self.freeOverTimeProcessCellAuditBlock(self.tag);
    }
}
