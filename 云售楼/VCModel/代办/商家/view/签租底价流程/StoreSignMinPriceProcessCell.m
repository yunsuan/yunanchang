//
//  StoreSignMinPriceProcessCell.m
//  云售楼
//
...
@implementation StoreSignMinPriceProcessCell
...
- (void)ActionAuditBtn:(UIButton *)btn{
    ...
    if (self.storeSignMinPriceProcessCellAuditBlock) {

        self.storeSignMinPriceProcessCellAuditBlock(self.tag);
    }
}
...
- (void)setDataDic:(NSMutableDictionary *)dataDic{
    ...
    _intentCodeL.text = [NSString stringWithFormat:@"签租编号：%@",dataDic[@"contact_id"]];
