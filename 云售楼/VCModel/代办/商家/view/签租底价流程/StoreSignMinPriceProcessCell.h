//
//  StoreSignMinPriceProcessCell.h
//  云售楼
//
...
typedef void(^StoreSignMinPriceProcessCellAuditBlock)(NSInteger index);

@interface StoreSignMinPriceProcessCell : UITableViewCell

@property (nonatomic, copy) StoreSignMinPriceProcessCellAuditBlock storeSignMinPriceProcessCellAuditBlock;
