...
@implementation ShopChangeAuditCell
...
- (void)ActionAuditBtn:(UIButton *)btn{
    ...
    if (self.shopChangeAuditCellAuditBlock) {

        self.shopChangeAuditCellAuditBlock(self.tag);
    }
}
...
- (void)setDataDic:(NSMutableDictionary *)dataDic{
    ...
    _codeL.text = [NSString stringWithFormat:@"签租编号：%@",dataDic[@"contact_id"]];
