...
typedef void(^ShopChangeAuditCellAuditBlock)(NSInteger index);

@interface ShopChangeAuditCell : UITableViewCell

@property (nonatomic, copy) ShopChangeAuditCellAuditBlock shopChangeAuditCellAuditBlock;
