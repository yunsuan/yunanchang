//
//  ShopRentPeriodChangeAuditCell.m
//  云售楼
//
...
@implementation ShopRentPeriodChangeAuditCell
...
- (void)ActionAuditBtn:(UIButton *)btn{
    ...
    if (self.shopRentPeriodChangeAuditCelllAuditBlock) {

        self.shopRentPeriodChangeAuditCelllAuditBlock(self.tag);
    }
}
...
- (void)setDataDic:(NSMutableDictionary *)dataDic{
    ...
    _originPeriodL.text = [NSString stringWithFormat:@"原租期：%@",dataDic[@"sign_agent_name"]];
    _changePeriodL.text = [NSString stringWithFormat:@"变更租期：%@",dataDic[@"sign_agent_name"]];
}
