//
//  ShopRentPeriodChangeAuditCell.h
//  云售楼
//
...
typedef void(^ShopRentPeriodChangeAuditCelllAuditBlock)(NSInteger index);

@interface ShopRentPeriodChangeAuditCell : UITableViewCell

@property (nonatomic, copy) ShopRentPeriodChangeAuditCelllAuditBlock shopRentPeriodChangeAuditCelllAuditBlock;
