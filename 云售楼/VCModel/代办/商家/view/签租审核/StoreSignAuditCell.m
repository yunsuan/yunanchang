...
@implementation StoreSignAuditCell
...
- (void)ActionAuditBtn:(UIButton *)btn{
    ...
    if (self.storeSignAuditCellAuditBlock) {

        self.storeSignAuditCellAuditBlock(self.tag);
    }
}
...
- (void)initUI{
    ...
    for (int i = 0; i < 11; i++) {
        ...
        switch (i) {
            ...
            {
                _propertyL = label;
                [_whiteView addSubview:_propertyL];
                break;
            }
            case 8:
            {
