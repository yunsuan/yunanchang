//
//  ShopRentPriceChangeAuditCell.h
//  云售楼
//
...
typedef void(^ShopRentPriceChangeAuditCellAuditBlock)(NSInteger index);

@interface ShopRentPriceChangeAuditCell : UITableViewCell

@property (nonatomic, copy) ShopRentPriceChangeAuditCellAuditBlock shopRentPriceChangeAuditCellAuditBlock;
